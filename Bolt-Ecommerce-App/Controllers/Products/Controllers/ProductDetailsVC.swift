...
class ProductDetailsVC: UIViewController, rateViewDelegate {
    ...
    private func addItemToCart() {
        ...
        do {
            ...
            if let existingItems = matchingItems.first{
                ...
                let cartItem = CartItems(context: managedContext)
                cartItem.quantity = 1
    ...
    //MARK: - UpdateUI
    private func setButtonColor(button: CustomButton) {
